 ...
 * @author User
 */
public class PaymentAcceptSceneController implements Initializable {
    ...
    @FXML
    private TextField ToalTextField;
    @FXML
    ...
    public String viewCustomerPayment(){
        File p = null;
        FileInputStream fis = null;      
        ObjectInputStream ois = null;
        String r = null;
        try {
            p = new File("Payment.bin");
            fis = new FileInputStream(p);
            ois = new ObjectInputStream(fis);
           Payment rs;
            try{
                while(true){
                    rs = ( Payment)ois.readObject();
                   if(r==null){
                      r=rs.toString(); 
                   }else{ 
                   r=r+ rs.toString();
    ...
    @FXML
    private void AcceptButton(MouseEvent event) {
               
        Payment rs = new Payment(
                ShowsNameComboBox.getValue(),
                Float.parseFloat(ToalTextField.getText()),
                Float.parseFloat(CashTextField.getText()),
                Float.parseFloat(ChangeTextFIeld.getText()));
        ...
        try {
         ...
         ReceiptTxtArea.appendText(viewCustomerPayment());
    }
}
